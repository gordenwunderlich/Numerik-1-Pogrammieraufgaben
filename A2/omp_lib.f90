...
! $Revision: 33691 $
! $Date: 2017-02-21 22:52:52 -0800 (Tue, 21 Feb 2017) $
...
! </copyright>
      ...
      module omp_lib
        ...
        integer (kind=omp_integer_kind), parameter :: kmp_version_build = 20170210
        character(*)               kmp_build_date
        parameter( kmp_build_date = '2017-02-11 20:08:43 UTC' )
...
!         ***
          ...
          pure function omp_get_wtime() bind(c)
            use omp_lib_kinds
